...
public class Main {
       ...
       while(loop) {
           try {
               ...
               switch (opcao) {
                   ...
                   case MOSTRAR_ITENS -> mostrarItensDaEstante();
    ...
    public static void mostrarAvaliacoes(Item i) {
        i.getAvaliacoes().forEach(a -> {
            System.out.print(a.getDataAvaliacao().format(DateTimeFormatter.ofPattern("'Data da avaliação: 'dd/MM/yyyy HH:mm:ss:nn'/n'")));
    ...
    public static void mostrarItensDaEstante() {
        if (loja.getEstantes().isEmpty()) {
            System.out.println("Sem estantes!");
        }
